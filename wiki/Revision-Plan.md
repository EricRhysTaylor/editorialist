...
**Schedule & options** holds the date, effort range, required-for-deadline flag, lock, prerequisite, and removal controls. **Remove from plan** preserves the source feedback. **Lock against auto-scheduling** protects the session during regeneration; manual editing remains available.
